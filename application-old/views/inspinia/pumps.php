                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                     ...
                     <tr>
                        ...
                        <td>
                           <a class="icon" href="<?php echo base_url(); ?>trips/delpump/<?php echo output($vehiclegroupdata['id']); ?>">
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         <div class="modal-header">
            <h4 class="modal-title">Add New Pump</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
            </button>
         </div>
         <div class="modal-body">
            <form id="geofencesave" method="post" action="<?php echo base_url(); ?>trips/addpump">
               <div class="card-body">
                  <div class="form-group row">
                     <label for="geo_name" class="col-sm-4 col-form-label">Name</label>
                     <div class="form-group col-sm-8">
                        <input type="text" class="form-control" name="name" id="exp_name" required="true" placeholder="Enter Pump Name">
                     </div>
                  </div>
               </div>
         </div>
