   ...
   <div class="container-fluid">
      <div class="row mb-2">
         <div class="col-sm-6 margin-left-15">
            <h1 class="m-0 text-dark">Vehicle Parts Types
            </h1>
         </div>
      </div>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                     ...
                     <tr>
                        ...
                        <td> <?php echo output($vehiclegroupdata['name']); ?></td>
                        <?php if(userpermission('lr_vech_group_action')) { ?>
                        <td>
                           <a class="icon" href="<?php echo base_url(); ?>tracking/livestatus/<?php echo output($vehiclegroupdata['id']); ?>">
                           <i class="fa fa-map"></i> |  
                           <a class="icon" href="<?php echo base_url(); ?>vehicle/vehiclegroup_delete/<?php echo output($vehiclegroupdata['id']); ?>">
