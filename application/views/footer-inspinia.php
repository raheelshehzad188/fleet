...
?>
    ...
    <!-- EayPIE -->
    <script src="<?= $url ?>js/plugins/easypiechart/jquery.easypiechart.js"></script>
...
<script src="<?= base_url(); ?>assets/plugins/datetimepicker/datetimepicker.js"></script>
   ...
   <?php if ($this->session->flashdata('successmessage')) { ?>
      const Toast = Swal.mixin({toast: true,position: 'top',showConfirmButton: false,timer: 50000});
      Toast.fire({
       type: 'success',
