        ...
        <form method="post" id="vehicle_add" class="card basicvalidation" action="<?php echo base_url();?>users/<?php echo (isset($userdetails))?'updateuser':'insertuser'; ?>">
                <div class="card-body">
                 ...
                 <?php } ?>
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Vehicle</label>

                                    <div class="col-sm-10"><label class="checkbox-inline"> <input type="checkbox" value="option1" id="inlineCheckbox1"> All List </label> <label class="checkbox-inline">
