                    ...
                    <div class="ibox-content border_box" >
                     ...
                     <tr>
                        ...
                        <td> <?php echo $type_staff['name']; ?></td>
                         <td> <span class=" <?= ($type_staff['is_default'] == 1) ? 'badge badge-success' : 'badge badge-default ' ?>"><?= ($type_staff['is_default'] == 1) ? 'Yes' : 'No' ?></span></td>
   ...
   <div class="col-lg-5">
                    ...
                    <div class="ibox-content box_inner border_box">
                        ...
                        <div class="box_content">
                            ...
                            $tbl = (isset($detail['tbl'])?$detail['tbl']:' ');
                                ...
                                {
                                    ?>
                                    <form id="staff_type" method="post" action="<?php echo base_url(); ?>settings/crud/<?= $detail['tbl'] ?>/update/<?= $staff_update_data['id'] ?>">
                                    <?php
                                }
                                else
                                {
    ...
    <div class="card-body">
        <div class="form-group">
            ...
            ?>
            <input type="text" class="form-control" value="<?= (isset($staff_update_data) ? $staff_update_data['name'] : '') ?>" name="name" id="name" required="true" placeholder="Expense Type">
            <label for="geo_name">Is Default</label>
            <select class="form-control" name="is_default">
                <option value="1" <?= (isset($staff_update_data) && $staff_update_data['is_default'] == 1)?'selected':'' ?>>Yes</option>
                <option value="0" <?= (isset($staff_update_data) && $staff_update_data['is_default'] == 0)?'selected':'' ?>>No</option>
            </select>
