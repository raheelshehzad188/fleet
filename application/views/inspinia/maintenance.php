   ...
   <div class="col-lg-5">
    ...
    <div class="card-body">
        <div class="form-group">
            <label for="geo_name">Maintenance Name</label>
            <?php
            ...
            ?>
            <input type="text" class="form-control" value="<?= (isset($staff_update_data) ? $staff_update_data['tyre_name'] : '') ?>" name="tyre_name" id="tyre_name" required="true" placeholder="Maintenance name">

        </div>
        <div class="form-group">
            <label for="geo_name">Maintenance Type</label>
            <select name="tyre_type" class="form-control">
                <option value="0" <?= (isset($staff_update_data) && $staff_update_data['tyre_type'] == 0) ? 'selected' : ''; ?>>By date</option>
                <option value="1"  <?= (isset($staff_update_data) && $staff_update_data['tyre_type'] == 1) ? 'selected' : ''; ?>>By km</option>
            </select>
