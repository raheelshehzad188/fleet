...
<section class="content">
                    ...
                    <div class="ibox-content border_box" >
                     ...
                     <?php if(!empty($type_staff)){  $count=1;
                        foreach($type_staff as $type_staff){
                            ...
                            $this->db->where('id', $type_staff['vehicle_type']);
                            $query = $this->db->get('vih_types'); 
                            $vehicle_name =$query->result_array();
                     ...
                     <tr>
                        ...
                        <td> <?php echo $vehicle_name[0]['name']; ?> </td>
   ...
   <div class="col-lg-5">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            <label for="geo_name">Vehicle Type</label>
            <select name="vehicle_type" class="form-control">
                ...
                if (!empty($vehicle_types)) {
                    foreach($vehicle_types as $vehicle_type){
                       ...
                       <option value="<?= $vehicle_type['id']  ?>" <?= (isset($staff_update_data) && $staff_update_data['vehicle_type'] == $vehicle_type['id']) ? 'selected' : ''; ?>><?= $vehicle_type['name']  ?></option>
                       <?php
                    }
